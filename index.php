...
//   return;
// }
// if (!$oauth_credentials = file_exists('/oauth-credentials.json')) {
//   echo missingOAuth2CredentialsWarning();
//   echo 'Notfound';
//   return;
// }
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $client->getAccessToken()) {
  ...
  $file->setName("Test Media");
  $result1 = $service->files->create(
      $file,
      array(
...
<?php if (isset($authUrl)): ?>
  <div class="request">
    <a class='login' href='<?= $authUrl ?>'>Login with Google</a>
  </div>
<?php elseif($_SERVER['REQUEST_METHOD'] == 'POST'): ?>
  <div class="shortened">
    <p>Your call was successful! Check your drive for the following files:</p>
    <ul>
      <li><a href="https://drive.google.com/open?id=<?= $result1->id ?>" target="_blank"><?= $result1->name ?></a></li>
